...
class SkillsLoader:
    ...
    2. builtin_skills/             - default skills bundled with clawbot
    """
    ...
    def list_skills(
        ...
        # 2. Built-in skills (bundled with clawbot)
    ...
    def _parse_skill_metadata(self, raw: str) -> dict:
        """Parse skill metadata JSON from frontmatter (supports clawbot and openclaw keys)."""
        try:
            data = json.loads(raw)
    ...
    def _get_skill_meta(self, name: str) -> dict:
        """Get clawbot metadata for a skill (cached in frontmatter)."""
