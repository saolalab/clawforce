...
### Legal Basis
- [ ] Identified legal basis for each data processing activity (consent, contract, legal obligation, vital interests, public task, legitimate interests)
- [ ] Documented legal basis for each processing activity
- [ ] Consent mechanisms meet GDPR standards (freely given, specific, informed, unambiguous)

### Data Subject Rights
- [ ] Right to access — Process for handling data subject access requests (30-day response time)
- [ ] Right to rectification — Process for correcting inaccurate data
- [ ] Right to erasure ("right to be forgotten") — Process for deleting data upon request
- [ ] Right to restrict processing — Process for limiting how data is used
- [ ] Right to data portability — Process for providing data in machine-readable format
- [ ] Right to object — Process for handling objections to processing
- [ ] Automated decision-making — Procedures for handling automated decisions and profiling

### Data Protection Measures
- [ ] Data Protection Impact Assessment (DPIA) conducted for high-risk processing
- [ ] Privacy by Design and Privacy by Default implemented
...
- [ ] Privacy policy updated and GDPR-compliant
- [ ] Data processing agreements (DPAs) with all processors
- [ ] Breach notification procedures documented (72-hour notification requirement)
- [ ] Data Protection Officer (DPO) appointed if required

### Third-Party Processors
- [ ] DPAs executed with all third-party processors
- [ ] Processors meet GDPR requirements
- [ ] Sub-processor approval mechanisms in place
...
### Consumer Rights
- [ ] Right to know — Process for disclosing what personal information is collected, used, shared, or sold
- [ ] Right to delete — Process for deleting personal information upon request (45-day response time)
- [ ] Right to opt-out — Process for opting out of sale of personal information
- [ ] Right to non-discrimination — No discrimination against consumers who exercise rights

### Notice Requirements
- [ ] Privacy policy includes required CCPA disclosures
- [ ] "Do Not Sell My Personal Information" link on homepage (if applicable)
- [ ] Notice at collection provided when collecting personal information
- [ ] Notice of financial incentive provided if applicable

### Data Inventory
- [ ] Inventory of personal information collected
- [ ] Categories of sources identified
- [ ] Business purposes for collection documented
- [ ] Third parties with whom information is shared identified

### Verification Procedures
- [ ] Process for verifying consumer identity before responding to requests
- [ ] Authorized agent procedures established
- [ ] Response procedures documented (45-day response time, 90-day extension if needed)

### Employee/Contractor Data
- [ ] Notice at collection for employees and contractors
- [ ] Limited exemptions for employee data understood
- [ ] Procedures for handling employee data requests
